...
const renderCalendar = () => {
  ...
  for (let i = 1; i <= lastDateofMonth; i++) {
    ...
    liTag += `<li class="${isToday}" onclick="openSamplePage(${currYear}, ${currMonth + 1}, ${i})">${i}</li>`;
  }
...
function openSamplePage(year, month, day) {
  ...
  const url = `/stock/save?selectedYear=${year}&selectedMonth=${month}&selectedDay=${day}&productCode=${p}`;
